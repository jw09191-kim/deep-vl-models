...
class Qwen3_5VJEPAModel(Qwen3_5ForConditionalGeneration):
    ...
    def _validate_model_kwargs(self, model_kwargs):
        # num_soft_tokens_* is produced by the processor but consumed only by the
        # Swift Qwen template's _extend_tokens path (via image_grid_thw).
        # Qwen3.5 base class does not accept these, so we pop here.
